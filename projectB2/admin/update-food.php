...
<?php
    ...
    if(isset($_GET['id']))
    {
        ...
        //sql query th get the selected food
...
<div class="main-content">
    <div class="wrapper">
        ...
        {
            // echo "clicked";
            //1. get all th details from form
            $id = $_POST['id'];
            $title = $_POST['title'];
            ...
            if(isset($_FILES['image']['name']))
            {
                ...
                if($image_name!="")
                {
                    ...
                    //get the sorce path and destination path
                    ...
                    //3. remove the image if new image uploaded
